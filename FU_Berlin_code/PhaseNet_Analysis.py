    ...
    def __init__(self,phasenet_direc: 'str', chile_GFZ_online_direc:'str', export_DF_path:'str',
        ...
        Parameters initialization:
            ...
            - analysis (boolean): Because running PhaseNet is time consumming, analysis variable helps to use existing 
                ...
                If we want to run PhaseNet for the first time in the given interval, this variable should be set to True
                If we have already "PhaseNet_result_s_picks.pkl", "PhaseNet_result_s_picks.pkl" for the given interval, this variable should be set to False.
